    ...
    <section className="bg-gradient-to-r from-blue-700 to-indigo-900 text-white py-32 px-8 text-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto space-y-8">
        ...
        <button 
          ...
          className="bg-white text-blue-800 hover:bg-gray-50 px-10 py-4 rounded-full font-semibold shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl uppercase tracking-wider text-sm mt-4 cursor-pointer"
        >
          Shop Sale
        </button>
      </div>
